<template>
    <div class="app-container">
        <div class="filter-container">
            ...
            <el-input v-for="(item, index) in whereJson" clearable v-model="where[item.prop]"
                :placeholder="item.placeholder" style="width: 160px;margin-right: 5px;" :key="index" class="filter-item" />
...
export default {
    ...
    data() {
        return {
            ...
            columnJson: [
                { prop: 'id', label: 'id' },
                { prop: 'ids', label: 'ids' },
                { prop: 'group_id', label: 'group_id' },
                { prop: 'message_id', label: 'message_id' },
                { prop: 'message', label: 'message', tooltip: true },
                { prop: 'message_from_id', label: 'fromId' },
                { prop: 'group_title', label: '群名称' },
                { prop: 'group_username', label: '群名' },
                { prop: 'create_time', label: '时间' }
            ],
            whereJson: [
                { prop: 'group_id', placeholder: '群id' },
                { prop: 'group_title', placeholder: '群昵称' },
    ...
    methods: {
        ...
        updateData() {
            this.drawer = false
            let postdata = {}
            postdata.table = 'anqi_telegram_message'
