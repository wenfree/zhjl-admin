<template>
    <div class="app-container">
        ...
        <el-drawer :title="drawerTitle" :visible.sync="drawer" direction="rtl" size="85%">
            <el-main>
                ...
                <pagination :total="groupPage.total" :page.sync="groupPage.page" :limit.sync="groupPage.size"
                    @pagination="getGroupInfo" :page-sizes="[20, 100, 200, 300, 400, 500, 1000, 5000, 10000]" />
            </el-main>
    ...
    data() {
        return {
            ...
            groupInfoColumn: [
                ...
                { prop: 'note', label: '备注' },
                { prop: 'update_time', label: '时间', width: '170px' }
            ],
            whereJson: [
    ...
    methods: {
        ...
        look(row) {
            ...
            this.drawerTitle = '查看' + row.channel_title + '群成员',
                this.groupWhereId = row.channel_id
            this.getGroupInfo()
        },
        getGroupInfo() {
            ...
            postdata.page = this.groupPage.page
            postdata.size = this.groupPage.size
            postdata.where = JSON.stringify({ group_id: this.groupWhereId })
