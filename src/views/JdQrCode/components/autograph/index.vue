<template>
  <div class="xhy-autograph-box">
    <div class="autograph-box">
      ...
      <div class="btn-box">
        <el-button class="btn-clear" @click="againSignature">Re 重新簽名</el-button>
        <el-button class="btn-confirm" plain type="primary" @click="confirm">{{ button_text }}</el-button>
      </div>
    </div>
  ...
  methods: {
    init() {
      if (!this.signaturePad) {
        const canvas = document.querySelector('.xhy-canvas')
    ...
    initFull() {
      if (!this.signaturePadFull) {
        const canvas = document.querySelector('.xhy-canvasFull')
    ...
    confirm() {
      try {
        const _flag = this.signaturePad.isEmpty()
    ...
    confirmFull() {
      try {
        const _flag = this.signaturePadFull.isEmpty()
        this.signaturePad.clear()
        if (!_flag) {
