    ...
    <el-row :gutter="24" class="panel-group">
      <el-col :span="24">
        <el-main style="background-color: #fff;">
          ...
          <el-row :gutter="24" class="panel-group">
            <el-col v-for="(item, index) in iconJson" :key="index" :span="6" class="card-panel-col">
        ...
        <el-main style="background-color: #fff;margin-top: 20px;">
          ...
          <div v-for="(item, index) in setpJson" :key="index" class="card-step">
            ...
            <el-steps :active="item.step" finish-status="success">
              <el-step title="登记" :description="item.time1" />
              <el-step title="检测中" :description="item.time2" />
              <el-step title="检测完毕" :description="item.time3" />
              <el-step title="证书出库" :description="item.time4" />
            </el-steps>
          </div>
