    ...
    children: [
      {
        ...
        name: '仪器例表',
        meta: { title: '仪器例表', icon: 'el-icon-odometer', noCache: true, roles: ['zhjl'] }
      },
      {
        path: 'certificate',
        component: () => import('@/views/zhjl-zzh/zhjl-Instrument.vue'),
        name: '证书管理',
        meta: { title: '证书管理', icon: 'el-icon-files', noCache: true, roles: ['admin'], hidden:true }
      }
    ]
  },
  {
    ...
    children: [
      {
        ...
        name: '订单台账',
        meta: { title: '完工单管理', icon: 'el-icon-shopping-cart-1', noCache: true, roles: ['zhjl'] }
      }
    ]
  },
  {
    ...
    children: [
      ...
      {
        path: 'organization',
        component: () => import('@/views/permission/zhjl_o.vue'),
        name: '溯源机构',
        meta: { title: '溯源机构', icon: 'el-icon-office-building', noCache: true, roles: ['admin'] }
      },
      {
        path: 'role',
        component: () => import('@/views/permission/zhjl_role.vue'),
        name: '角色管理',
        meta: { title: '角色管理', icon: 'el-icon-office-building', noCache: true, roles: ['admin'] }
      }
    ]
  },
