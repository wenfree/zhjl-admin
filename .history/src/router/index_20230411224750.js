...
export const constantRoutes = [
    ...
    {
        path: '/JdQrCode',
        component: () => import('@/views/JdQrCode/index'),
        mate: { title: '禁毒码' },
        hidden: false
    },
    {
...
export const asyncRoutes = [
    ...
    },
    {
        ...
        children: [
            {
                path: 'index',
                component: () => import('@/views/hzj-zzh/index.vue'),
                name: '用户信息',
                meta: { title: '用户信息', icon: 'peoples', noCache: true, roles: ['fibrpro-admin'] }
            },
            {
                path: 'work',
                component: () => import('@/views/hzj-zzh/work.vue'),
                name: '个人工作台',
                meta: { title: '用户信息', icon: 'peoples', noCache: true, roles: ['fibrpro-admin'] }
            },
        ]
