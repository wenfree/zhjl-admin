      ...
      <el-row :gutter="20" class="panel-group">
        <el-col :span="16">
          ...
          <el-main style="background-color: #fff;margin-top: 20px;">
            ...
            <lineText>
              <i class="el-icon-discount" style="color: red;" />委托单号: 123123
              <el-steps :active="3">
                <el-step title="登记" description="这是一段很长很长很长的描述性文字"></el-step>
                <el-step title="检测中" description="这是一段很长很长很长的描述性文字"></el-step>
                <el-step title="检测完毕" description="这段就没那么长了"></el-step>
                <el-step title="证书出库" description="这段就没那么长了"></el-step>
