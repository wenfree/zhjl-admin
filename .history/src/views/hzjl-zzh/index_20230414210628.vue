...
export default {
  ...
  data() {
    return {
      username:'',
      iconJson: [
        { icon: 'el-icon-alarm-clock', name: '已超期', count: 36 },
        { icon: 'el-icon-alarm-clock', name: '15天预警', count: 36 },
        { icon: 'el-icon-alarm-clock', name: '30天预警', count: 36 },
        { icon: 'el-icon-alarm-clock', name: '3个月预警', count: 36 },
      ]
