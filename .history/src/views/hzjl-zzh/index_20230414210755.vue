      ...
      <el-row :gutter="20" class="panel-group">
        <el-col :span="16">
          <el-main style="background-color: #fff;">
            ...
            <el-row :gutter="20" class="panel-group">
              <el-col :span="5" v-for="(item, index) in iconJson" :key="index" class="card-panel-col">
                <div class="card-panel">
                  ...
                  <div class="card-panel-description">
                    ...
                    <count-to :start-val="0" :end-val="22" :duration="item.count" class="card-panel-num" />
                  </div>
                </div>
              </el-col>
  ...
  data() {
    return {
      ...
      iconJson: [
        ...
        { icon: 'el-icon-alarm-clock', name: '15天预警', count: 35 },
        { icon: 'el-icon-alarm-clock', name: '30天预警', count: 60 },
        { icon: 'el-icon-alarm-clock', name: '3个月预警', count: 152 },
      ]
