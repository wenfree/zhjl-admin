    ...
    data() {
        return {
            ...
            columnJson: [
                ...
                { prop: 'nickname', label: '型号规格' },
                { prop: 'nickname', label: '制造厂家' },
                { prop: 'nickname', label: '出厂编号' },
                { prop: 'nickname', label: '管理编号' },
                { prop: 'nickname', label: '校准历史明细' },
                { prop: 'nickname', label: '校准日期' },
                { prop: 'nickname', label: '溯源机构' },
                { prop: 'nickname', label: '有效日期' },
                { prop: 'nickname', label: '证书预览' },
                { prop: 'nickname', label: '证书下载' },
                { prop: 'nickname', label: '证书上传' },
                { prop: 'nickname', label: '证书确认' },
            ],
