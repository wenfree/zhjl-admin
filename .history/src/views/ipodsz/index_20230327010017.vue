<template>
    <div class="app-container">
        <div class="filter-container">
            ...
            <el-input v-for="item in whereJson" :key="item.prop" v-model="where[item.prop]" clearable
                :placeholder="item.placeholder" style="width: 160px;margin-right: 5px;" class="filter-item" />
    ...
    data() {
        return {
            ...
            columnJson: [
                ...
                { prop: 'type', label: '最后动作' },
                { prop: 'in', label: '入库' },
                { prop: 'in_note', label: '入库备注' },
                { prop: 'by', label: '保压' },
                { prop: 'by_note', label: '保压备注' },
                { prop: 'out', label: '出库' },
                { prop: 'out_note', label: '出库备注' },
                { prop: 'back', label: '退货' },
                { prop: 'back_note', label: '退货备注' },
                { prop: 'update_time', label: '时间' }
            ],
            whereJson: [
                { prop: 'date', placeholder: '日期', type:'date' },
                { prop: 'leftbaddr', placeholder: '左耳baddr' },
                { prop: 'rightbaddr', placeholder: '右耳baddr' },
                { prop: 'type', placeholder: '最后动作' },
                { prop: 'in_note', placeholder: '入库' },
                { prop: 'by_note', placeholder: '保压' },
                { prop: 'out_note', placeholder: '出货' },
                { prop: 'back_note', placeholder: '退货' },
                { prop: 'create_time > ?', placeholder: '前', type:'date' },
                { prop: 'create_time < ?', placeholder: '后', type:'date' },
            ],
