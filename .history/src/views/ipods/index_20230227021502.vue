  ...
  <div class="app-container">
    <div class="filter-container">
      <template v-for="item in whereJson">
        <el-input v-model="where[item.prop]" :placeholder="item.placeholder" style="width: 120px;margin-right: 5px;"
          class="filter-item" />
      </template>
      <el-input v-model="where.leftbaddr" placeholder="左耳" style="width: 200px;" class="filter-item" />
      <el-input v-model="where.rightbaddr" placeholder="右耳" style="width: 200px;" class="filter-item" />
