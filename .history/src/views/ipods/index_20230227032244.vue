<template>
  <div class="app-container">
    <div class="filter-container">
      ...
      <el-button v-waves :loading="downloadLoading" type="primary" icon="el-icon-document" @click="handleDownload"
        class="filter-item">
        导出数据
      </el-button>
    </div>
  ...
  methods: {
    ...
    handleDownload() {
      ...
      import('@/vendor/Export2Excel').then(excel => {
        ...
        const filterVal = ['date', 'leftbaddar', 'rightcaddar']
        const data = this.formatJson(filterVal)
        excel.export_json_to_excel({
          header: tHeader,
          data,
          filename: '耳机数据' + new data().toLocaleString
        })
