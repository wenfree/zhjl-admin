      ...
      <el-form ref="form" :model="form" :rules="Rules" label-width="200px" label-position="top">
        ...
        <el-form-item>
          <div class="submit" style="display:flex">
            <el-button type="primary" @click="dialogVisible = true">展示二维码</el-button>
          </div>
          <div class="submit" style="display:flex">
...
————————————————
    版权声明：本文为CSDN博主「lileLife」的原创文章，遵循CC 4.0 BY - SA版权协议，转载请附上原文出处链接及本声明。
    原文链接：https://blog.csdn.net/lileLife/article/details/103846079
  }
}
</script>
