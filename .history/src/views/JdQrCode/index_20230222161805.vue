<template>
  <div class="login-container">
    ...
    <el-form ref="form" :model="form" :rules="loginRules" label-width="200px" label-position="top">
      ...
      <el-form-item label="smscode" class="code">
        <el-input v-model="code" placeholder="验证码"></el-input>
        <el-image style="width: 100px; height: 100px" :src="code_img" fit="contain"></el-image>
      </el-form-item>
...
import SwitchRoles from '../permission/components/SwitchRoles.vue'
