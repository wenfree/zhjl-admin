    ...
    <div class="login-container">
      ...
      <el-form ref="form" :model="form" :rules="Rules" label-width="200px" label-position="top">
        ...
        <el-form-item class="idcard_img">
          <el-upload :data="dataObj" action="http://up-z2.qiniup.com" :show-file-list="false" :on-success="handleSuccess"
...
export default {
  ...
  methods: {
    ...
    handleSuccess(val) {
      console.log('成功', val)
      this.form.filePath = 'https://hongkongidcard.wenfree.cn/' + val.key
