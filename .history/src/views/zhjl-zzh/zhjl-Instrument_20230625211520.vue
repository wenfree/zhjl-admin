    ...
    >
      <el-main>
        <el-form :model="historyList" label-width="100px">
          <el-form-item label="仪器名称：" style="margin-bottom: 4px;">
            <el-input v-model="historyList.instrument_name" ></el-input>
          </el-form-item>
          <el-form-item label="制造厂家：" style="margin-bottom: 4px;">
            <el-input v-model="historyList.instrument_name"></el-input>
          </el-form-item>
          <el-form-item label="型号规格：" style="margin-bottom: 4px;">
            <el-input v-model="historyList.instrument_name"></el-input>
          </el-form-item>
          <el-form-item label="出厂编号：" style="margin-bottom: 4px;">
            <el-input v-model="historyList.instrument_name"></el-input>
          </el-form-item>
          <el-form-item label="管理编号：" style="margin-bottom: 4px;">
            <el-input v-model="historyList.instrument_name"></el-input>
          </el-form-item>
        </el-form>
