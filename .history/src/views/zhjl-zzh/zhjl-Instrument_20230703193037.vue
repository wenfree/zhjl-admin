    ...
    >
      ...
      <el-form>
        <el-form-item label="导入excel: ">
          <input id="excel-upload" ref="fileInput" type="file" accept=".xlsx, .xls" name="excel-upload" @change="uploadExcel">
        </el-form-item>
