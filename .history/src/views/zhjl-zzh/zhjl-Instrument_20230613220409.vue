  ...
  data() {
    return {
      ...
      whereJson: [
        ...
        { prop: 'checkDate', placeholder: '校验日期', label:'校验日期', type: 'daterange',statr:'启始日期', end:'结束日期' },
        { prop: 'Havedate', placeholder: '有效日期',label:'有效日期', type: 'daterange',statr:'启始日期', end:'结束日期' },
