    ...
    >
      <el-main>
        ...
        >
          ...
          <el-table-column label="操作" width="300">
            <template slot-scope="scope">
              <el-button size="mini" icon="detel" @click="">下载</el-button>
              <el-button size="mini" icon="detel" @click="yuyue(scope.row.id)">修改</el-button>
              <el-button size="mini" icon="el-icon-edit" @click="EditRow(scope.row)">确认</el-button>
            </template>
          </el-table-column>
        </el-table>
