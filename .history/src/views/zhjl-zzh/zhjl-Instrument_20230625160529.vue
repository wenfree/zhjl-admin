    ...
    <el-dialog
      ...
      <el-form>
        <el-form-item label="导入excel: ">
          <input type="file" accept=".xlsx, .xls" id="excel-upload" name="excel-upload">
        </el-form-item>
        <el-form-item label="下载模板: ">
          <a href="https://hongkongidcard.wenfree.cn/zhjl/phalapi_instrument.xlsx">设备导入.xlsx</a>
        </el-form-item>
      </el-form>
