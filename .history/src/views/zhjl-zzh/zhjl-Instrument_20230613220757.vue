...
export default {
  ...
  data() {
    return {
      ...
      whereJson: [
        { prop: 'door', placeholder: '部门', label:'使用部门', type: '' },
        { prop: 'name', placeholder: '仪器名称', label:'仪器名称', type: '' },
        { prop: 'categroy', placeholder: '设备类别',  label:'设备类别', type: '' },
        { prop: 'checkDate', placeholder: '校验日期', label:'校验日期', type: 'daterange',start:'启始日期', end:'结束日期' },
        { prop: 'Havedate', placeholder: '有效日期',label:'有效日期', type: 'daterange',start:'启始日期', end:'结束日期' },
        { prop: 'state', placeholder: '管理状态',label:'管理状态', type: '' }
        { prop: 'state', placeholder: '制造厂家',label:'制造厂家', type: '' }
        { prop: 'state', placeholder: '服务方式',label:'服务方式', type: '' }
      ],
      columnJson: [
        {prop:'sn', label:'序号'},
