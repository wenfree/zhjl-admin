  ...
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="操作" width="222">
        <template slot-scope="scope">
          <el-button size="mini" icon="detel" @click="delById(scope.row.id)">保存</el-button>
...
export default {
  ...
  data() {
    return {
      ...
      whereJson: [
        { prop: 'date', placeholder: '委托日期', type: 'daterange' },
        { prop: 'name', placeholder: '仪器名称' },
        { prop: 'name', placeholder: '订单状态' },
        { prop: 'date', placeholder: '完工日期', type: 'daterange' }
      ],
      columnJson: [
        { prop: 'id', label: 'id' },
        { prop: 'username', label: '委托单号' },
        { prop: '1', label: '联系人' },
        { prop: '2', label: '证书单位' },
        { prop: '3', label: '联系电话' },
        { prop: '4', label: '委托日期' },
