      ...
      <el-main>
        ...
        >
          ...
          <el-table-column label="操作" width="360">
            <template slot-scope="scope">
              <el-button size="mini" icon="detel" @click="todoZS('download')">下载证书</el-button>
              <el-button size="mini" icon="detel" @click="todoZS('make')">修改证书</el-button>
              <el-button size="mini" icon="el-icon-edit" @click="todoZS('comfirm')">确认证书</el-button>
            </template>
          </el-table-column>
        </el-table>
