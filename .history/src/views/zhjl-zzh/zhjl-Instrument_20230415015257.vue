...
export default {
  ...
  data() {
    return {
      ...
      whereJson: [
        { prop: 'date', placeholder: '部门', type: '' },
        { prop: 'name', placeholder: '仪器名称' },
        { prop: 'name', placeholder: '设备类别' },
        { prop: 'date', placeholder: '校验日期', type: 'daterange' },
        { prop: 'date', placeholder: '有效日期', type: 'daterange' },
        { prop: 'date', placeholder: '管理状态', type: '' }
      ],
      columnJson: [
        { prop: 'id', label: 'id' },
