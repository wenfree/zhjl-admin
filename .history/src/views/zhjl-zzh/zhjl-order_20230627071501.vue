  ...
  <div class="app-container">
    ...
    <div class="filter-container">
      <el-form ref="where" :model="where" label-width="80px" :inline="true">
        ...
        <el-button v-waves class="filter" type="el-icon-refresh-right" icon="el-icon-search" @click="getList">
          重置
        </el-button>
      </el-form>
    </div>
    ...
    <div class="filter-container">
      ...
      <el-button v-waves class="filter-item" type="info" icon="el-icon-plus" @click="handleFilter">
        批量删除
      </el-button>
      <el-button v-waves class="filter-item" type="" icon="el-icon-plus" @click="handleFilter">
        批量提交
      </el-button>
    </div>
    ...
    >
      ...
      <el-table-column label="操作" width="300">
        <template slot-scope="scope">
          <el-button size="mini" icon="detel" @click="history(scope.row)">预览</el-button>
          <el-button size="mini" icon="el-icon-edit" @click="EditRow(scope.row)">下载</el-button>
          <el-button size="mini" icon="detel" @click="delById(scope.row.id)">打印</el-button>
          <el-button size="mini" icon="detel" @click="delById(scope.row.id)">撤回</el-button>
        </template>
      </el-table-column>
