    ...
    <el-col :span="12">
        ...
        <el-form-item v-for="(pr, index) in form.product" :label="pr.model + '：'" :key="index">
            ...
            <el-form-item label="Length">
                <el-radio v-model="pr.opration.size" v-for="item in pr.lenght" :label="item" :key="item" @change="changeSize(index)">{{ item }}</el-radio>
            </el-form-item>
            ...
            this.form.product.push(
                {
                    ...
                    opration:{ width: products.width, size:'400', Thickness:'30', color:'1', slip:'R11', max:'300',level:'5KN',}
                })
