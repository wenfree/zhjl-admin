    ...
    <el-col :span="12">
        ...
        <el-form-item v-for="(pr, index) in form.product" :label="pr.model + '：'" :key="index">
            ...
            <el-form-item label="Length">
                <el-radio v-model="pr.opration.lenght" v-for="item in pr.lenght" :label="item" :key="item" @change="changeSize(index)">{{ item }}</el-radio>
            </el-form-item>
            <el-form-item label="Width">
                <el-input v-model="pr.opration.width"></el-input>
            </el-form-item>
            <el-form-item label="Thickness">
                <el-radio v-model="pr.opration.Thickness" v-for="item in pr.thinkness" :label="item" :key="item">{{ item }}</el-radio>
            </el-form-item>
...
export default {
    ...
    methods: {
            ...
            this.form.product.push(
                {
                    ...
                    opration:{ width: products.width, lenght: products.lenght[0], thinkness:products.thinkness[0], color:'1', slip:'R11', max: '',level:'',}
                })
        ...
        generate(val) {
            ...
            var that = this;
            this.loadFile("https://img.wenfree.cn/word/word.docx", function (error, content) {
            if (error) {
                throw error
            };
