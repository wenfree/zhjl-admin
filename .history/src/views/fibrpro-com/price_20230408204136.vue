...
<el-row :gutter="20">
    <el-col :span="12">
        ...
        <el-form-item v-for="(item, index) in form.product" :label="item.model + '：'" :key="index">
            <el-input v-model="item.acount" placeholder="請輸入數量"
                @change="ProductPrice()" ></el-input>
            ...
            <el-form-item label="Thickness">
                <el-radio v-model="form.Thickness" v-for="item in thickJson" :label="item.value" :key="item.value">{{ item.label }}</el-radio>
            </el-form-item>
            <el-form-item label="color">
                <el-input v-model="form.color"></el-input>
            </el-form-item>
            <el-form-item label="slip">
                <el-radio v-model="form.slip" v-for="item in slipJson" :label="item.value" :key="item.value">{{ item.label }}</el-radio>
            </el-form-item>
            <el-form-item label="max">
                <el-input v-model="form.max"></el-input>
            </el-form-item>
            <el-form-item label="loading level">
                <el-radio v-model="form.level" v-for="item in levelJson" :label="item.value" :key="item.value">{{ item.label }}</el-radio>
            </el-form-item>
        </el-form-item>
