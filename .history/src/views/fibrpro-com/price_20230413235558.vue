...
<el-row :gutter="20">
    ...
    <el-col :span="8">
        ...
        <el-form-item label="Mold Charge">
            ...
            <template v-if="form.mold_charge">
                <el-form-item label="Qty." style="margin-bottom: 5px;">
                    <el-input v-model="form.mold_charge_qty" @change="mold_chage"></el-input>
                </el-form-item>
                <el-form-item label="Unit Rate" style="margin-bottom: 5px;">
                    <el-input v-model="form.mold_charge_price" @change="mold_chage"></el-input>
                </el-form-item>
                <el-form-item label="Total Mold Charge">
                    <el-input v-model="form.mold_charge_total" disabled></el-input>
                </el-form-item>
            </template>
        </el-form-item>
        ...
        <el-form-item label="">
            <el-button :loading="downloadLoading" type="success" icon="el-icon-orange" class="filter-item"
