...
<el-row :gutter="20">
    <el-col :span="12">
        ...
        <!-- <el-form-item v-for="item in form.product" :label="item + '：'" :key="item.label">
...
export default {
    ...
    methods: {
        ...
        addProducts(products){
            ...
            this.form.product.push({model:products, opration:{  size:'', Thickness:'', color:'', slip:'',max:'',level:'',}})
        },
        handleClose(tag) {
            this.form.splice(this.form.indexOf(tag), 1);
        },
    }
}
</script>
