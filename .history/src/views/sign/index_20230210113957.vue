<template>
  <div class="login-container">
        ...
        <el-main class="flex no_padding">
            <div class="tables text1" style="width: 100%;padding:5px;padding-left:20px; border-top: 0;text-align: left">
                <strong>Class Arrangement</strong> 課程安排 (Please mark &or; in the appropriate box 請在適當方格 &or;)
            </div>
        </el-main>
        <el-main class="flex no_padding">
            <div class="tables text1" style="width: 30%;">
                <strong>Medium of Instruction</strong>上課語言
            </div>
            <div class="tables text2 none_left" style="width: 40%;">
                <strong>Training Venue</strong>上課地點
            </div>
            <div class="tables text2 none_left" style="width: 30%;">
