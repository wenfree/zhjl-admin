<template>
  <div class="login-container">
    ...
    <el-form ref="form" :model="form" :rules="loginRules" label-width="200px" label-position="top">
      ...
      <el-form-item label="">
        <el-checkbox v-model="agree">I do not wish to receive any information from the MLife Human Resources
          Development Centre in relation to its activities
      ...
      <el-form-item label="">
        <el-checkbox v-model="form['self']">报名表是否发给自己</el-checkbox>
      </el-form-item>
  ...
  data() {
    return {
      formJosn: [
        ...
        { label: '报名表发送给自己', type: 'checkbox', placeholder: '报名表发送给自己', key: 'self' },
      ],
      form: {
        names: null,
        en_name: null,
