<template>
  <div class="login-container">
    ...
    <el-form ref="loginForm" :model="loginForm" :rules="loginRules" label-width="200px" label-position="top">
      ...
      <el-form-item>
        <el-button type="primary" @click="submit('loginForm')">提交報名</el-button>
