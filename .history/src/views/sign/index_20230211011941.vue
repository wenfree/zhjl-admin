<template>
  <div class="login-container">
    <el-image style="height: 100px;" src="https://img.wenfree.cn/images/b.wenfree.cn/banner.png" fit="contain"></el-image>
    <el-main class="flex no_padding">
      <div class="tables text1" style="width: 100%;">
        Course: Mandatory Basic Safety Training Course (Construction Work) <br />
        【Green Card Training Course】<br />
        報讀課程：強制性基本安全訓練課程(建築工程)【平安卡(建築工程)課程】
      </div>
      <div class="tables text2 none_left" style="width: 100%;">
        Tel電話:2121 1598
      </div>
      <div class="tables text3 none_left" style="width: 100%;">
        Fax傳真:3905 5311
      </div>
    </el-main>
    <el-main class="flex no_padding">
      <div class="tables text1 none_left" style="width: 100%;padding:5px;padding-left:0; border-top: 0;text-align: left;">
        <strong>Class Arrangement</strong> 課程安排 (Please mark &or; in the appropriate box 請在適當方格 &or;)
      </div>
    </el-main>
    <el-main class="flex no_padding">
      <div class="tables text1" style="width: 100%;">
        <strong>Medium of Instruction</strong>上課語言
      </div>
      <div class="tables text2 none_left" style="width: 100%;">
        <strong>Training Venue</strong>上課地點
      </div>
      <div class="tables text2 none_left" style="width: 100%;">
        <strong>Training Hour</strong>上課時間
      </div>
    </el-main>
    <el-main class="flex no_padding">
      <div class="tables text1" style="width: 100%;">
      ...
      <div class="tables text2 none_left" style="width: 100%;">
        Flat A, 16/F, Wing Hong Centre, 18 Wing Hong Street, Cheung Sha Wan, KLN, Hong Kong
        <br />
        香港長沙灣永康街18號永康中心 16樓A室
      </div>
      <div class="tables text2 none_left" style="width: 100%;">
        1 day course 一天課程 (09:30 - 18:00)
      </div>
    </el-main>
    <div class="title-container">
      <h3 class="title">Registration Form</h3>
    </div>
    <el-form ref="form" :model="form" :rules="formRules" label-width="200px" label-position="top">
      ...
      <template v-for="item in formJosn">
        ...
        <template v-if="item.type == 'select-date'">
          <el-form-item :label="item.label" :key="item.key">
            <el-date-picker v-model="form[item.key]" type="date" placeholder="选择日期" value-format="yyyy-MM-dd">
            </el-date-picker>
          </el-form-item>
        </template>
      ...
      <div class="submit" style="display:flex">
        <el-button type="primary" @click="submit('form')">提交報名</el-button>
      </div>
    </el-form>
...
export default {
  ...
  data() {
    ...
    return {
      formJosn: [
        ...
        { label: 'Surname 姓', type: 'input', placeholder: 'Surname 姓', key: 'hongkong_firstName' },
        { label: 'Given Names 名', type: 'input', placeholder: 'Given Names 名', key: 'hongkong_lastName' },
        ...
        { label: 'Sex性别', type: 'radio', optionItems: [
                    { label: "男", value: "男" },
                    { label: "女", value: "女" },
                    { label: "其它", value: "其它" },
									], placeholder: 'Sex性别', key: 'sex' },
      ...
      formRules: {
        names: [{ required: true, message: '請輸入姓名', trigger: 'blur' }],
      },
      options: {
        penColor: 'black', //笔刷颜色
        minWidth: 2 //最小宽度
  ...
  methods: {
    ...
    submit(formRules) {
      ...
      //   console.log('保存数据', response.data)
      //   that.save_key = true
      //   this.$alert('表存成功', '报名表格', {
