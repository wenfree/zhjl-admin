  ...
  data() {
    ...
    return {
      formJosn: [
        ...
        { label: '(As shown on HKID Card or Passport 按香港身份證或護照所示)', type: 'text', placeholder: 'Given Names 名', key: 'en_name' },
        { label: 'Date of Birth 出生日期', type: 'select', placeholder: 'Given Names 名', key: 'en_name' },
      ],
      form: {
        name: ""
      },
