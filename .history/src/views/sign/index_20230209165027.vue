  ...
  data() {
    ...
    return {
      formJosn: [
        ...
        { label: '(As shown on HKID Card or Passport 按香港身份證或護照所示)', type: 'text', placeholder: 'As shown on HKID Card or Passport', key: 'hongkong_id' },
        ...
        { label: 'Sex性别', type: 'input', placeholder: 'Sex性别', key: 'sex' },
