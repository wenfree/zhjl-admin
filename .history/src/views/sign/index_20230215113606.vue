<template>
  <div class="login-container">
    ...
    <el-form ref="form" :model="form" :rules="loginRules" label-width="200px" label-position="top">
      ...
      <el-form-item label="">
        <el-checkbox v-model="form['msg']">I do not wish to receive any information from the MLife Human Resources
          Development
    ...
    <el-dialog title="《Personal Data Collection Statement》 《收集個人資料聲明》" :visible.sync="dialogVisible" width="95%"
      ...
      <ul>
        <li>1.The information you provide to the MLife Human Resources Development Centre (“MLife”), including any
          personal data as
          defined in the Personal Data (Privacy) Ordinance (the Ordinance), will be used solely for purposes related to
          the
          activities of the MLife.
          你向德鑄人力資源發展中心〔「德鑄」〕所提供的資料，包括《個人資料〔私隱〕條例》所指的個人資料，只會用於相關德鑄之活動。</li>
        <li>2.MLife will disclose the personal data you have provided to Labour Department for the following purposes:
          德鑄會將你提供的個人資料向勞工處透露，用作以下用途：
          a.activities relating to the administration of the Occupational Safety and Health Ordinance and Factories and
          Industrial
          Undertakings Ordinance and their subsidiary regulations;
          有關執行職業安全及健康條例、工廠及工業經營條例及其附例；
          b.communication regarding the course you attended; and
          方便勞工處與你聯絡有關其出席的課程事宜；及
          c.carrying on relevant research and compilation of statistical data.
          將有關資料用作研究及統計分析。</li>
        <li>3.To keep you informed of MLife activities and industry developments which may be of interest, the MLife
          would like to
          use your personal data, including your name, phone number and correspondence and email addresses, to update
          you in
          relation to training courses, trade testing, registration, events and other aspects of its work and the
          construction
          industry.
          為讓你得知最新的德鑄活動和行業內發展情況，德鑄將使用你的個人資料，包括你的姓名、電話號碼、郵寄和電郵地址，將有關訓練課程、測試、註冊、活動項目、議會或中心工作和建造業其他方面的最新資訊提供給你。</li>
        <li>4.The MLife will not transfer your personal data to any third parties without your prior consent.
          在未得你的事先同意前，德鑄不會將你的個人資料轉移給任何第三方。</li>
        <li>5.It is obligatory for you to supply the MLife with complete information. The MLife may be unable to process
          and/or
          consider your application if you do not provide complete information. You are free to decide whether you wish
          to receive
          such information. If you choose not to do so, please put a “”in the box below.
          你必須向德鑄提供完整的資料。如你未能提供完整的資料，德鑄或無法處理及/或考慮你的申請。你可選擇是否同意接收上述資訊。若不同意的話，請於下列有關拒收資訊一欄之空格內加上「」號。</li>
        <li>6.You are also entitled to request access to and correction of any errors in your personal data. If you wish
          to do so
          please write to the MLife at Flat A, 16/F, Wing Hong Centre, 18 Wing Hong Street, Cheung Sha Wan, KLN, Hong
          Kong.
          你有權要求查閱及修正你的個人資料。有關申請須以書面向德鑄提出，地址為香港長沙灣永康街18號永康中心 16樓A室。</li>
      </ul>
