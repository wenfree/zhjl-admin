<template>
  <div class="login-container">
    ...
    <el-form ref="form" :model="form" :rules="loginRules" label-width="200px" label-position="top">
        ...
        <template v-if="item.type == 'idcard'">
          <el-form-item :label="item.label" :key="item.key" :class="item.class ? item.class : 'noidcard'">
            <el-input v-model="form[item.key]" :placeholder="item.placeholder"></el-input>-<el-input
              v-model="form[item.key]" :placeholder="item.placeholder"></el-input>
          </el-form-item>
        </template>
      ...
      <el-form-item label="">
        <el-checkbox v-model="agree">Agree to collect personal information
          <p>同意收集個人信息</p>
        </el-checkbox>
      </el-form-item>

      <el-form-item label="">
        <el-checkbox v-model="form['self']">報名錶是否發給自己</el-checkbox>
      </el-form-item>
  ...
  data() {
    return {
      formJosn: [
        ...
        { label: 'Name (Chinese) 姓名 (中文)', type: 'input', placeholder: 'Name (Chinese) 姓名 (中文)', key: 'names', class: 'idcard' },
        ...
        { label: 'HKID/Passport No.香港身份證/護照號碼', type: 'idcard', placeholder: 'HKID/Passport No.香港身份證/護照號碼', key: 'idcard' },
        // { label: '', type: 'input', placeholder: '(最后一位)', key: 'idm' },
        ...
        { label: '報名錶發送給自己', type: 'checkbox', placeholder: '報名錶發送給自己', key: 'self' },
      ],
      form: {
        names: null,
        en_name: null,
