  ...
  data() {
    return {
      formJosn: [
        ...
        { label: 'Medium of Instruction 上課語言', type: 'title', placeholder: '', key: '上課語言' },
        { label: 'Cantonese 廣東話', type: 'text', placeholder: '', key: 'Cantonese 廣東話' },

        { label: 'Training Venue 上課地點', type: 'title', placeholder: '', key: '上課語言' },
        {
          label: 'Flat A, 16/F, Wing Hong Centre, 18 Wing Hong Street, Cheung Sha Wan, KLN, Hong Kong香港長沙灣永康街18號永康中心 16樓A室', type: 'text', placeholder: '', key: 'Cantonese 廣東話'
        },
