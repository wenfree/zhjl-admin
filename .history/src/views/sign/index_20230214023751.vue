      ...
      formJosn: [
...

        {
          label: 'Courses報讀課程：', type: 'radio', class: 'courses', optionItems: [
            ...
            { label: "Mandatory Basic Safety Training Revalidation Course (Construction Work) (Course Fee HK$170) Half day course (18:30 - 22:00)", value: "Course Fee HK$170 強制性基本安全訓練重新甄審資格課程(建築工程) (學費 HK$170) 半天課程 (18:30 - 22:00)" },
