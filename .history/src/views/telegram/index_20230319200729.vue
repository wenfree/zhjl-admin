    ...
    <div class="app-container">
        <div class="filter-container">
            <template v-for="item in whereJson">
                <el-input clearable v-model="where[item.prop]" :key="item.prop" :placeholder="item.placeholder"
        ...
        <el-drawer :title="drawerTitle" :visible.sync="drawer" direction="rtl" size="50%">
            <el-main>
                <el-form ref="form" :model="form" label-width="120px">
                    ...
                    <el-form-item> <el-button v-waves class="filter-item" type="primary" icon="el-icon-check"
                            @click="handleFilter">
                            {{ drawerTitle }}
...
export default {
    ...
    methods: {
        ...
        formatColunm(state) {
            if (state == 'id' || state == 'phone' || state == 'update_time') {
                return false
            }
            return true
        }
