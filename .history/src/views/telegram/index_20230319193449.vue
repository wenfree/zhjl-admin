    ...
    <div class="app-container">
        <div class="filter-container">
            <template v-for="item in whereJson">
                <el-input :key="item.label" v-model="where[item.prop]" clearable :placeholder="item.placeholder"
            ...
            <el-main>
                <el-form ref="form" :model="form" label-width="120px">
                    <template v-for="item in columnJson">
                        ...
                        <el-form-item v-if="item.prop != 'id' || item.prop != 'phone'" :key="item.label"
                            :label="item.label">
