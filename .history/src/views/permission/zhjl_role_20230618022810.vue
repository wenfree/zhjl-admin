...
export default {
  ...
  data() {
    return {
      ...
      whereJson: [
        { prop: 'role', placeholder: '角色', label: '角色' },
        { prop: 'role_name', placeholder: '角色名称', label: '角色名称' },
        { prop: 'role_name', placeholder: '角色名称', label: '角色名称' }
      ],
      columnJson: [
        // { prop: 'id', label: 'id' },
        { prop: 'role', label: '部门代码' },
        { prop: 'role_name', label: '部门名称' },
        { prop: 'cm_code', label: '公司代码' },
        { prop: 'cm_name', label: '公司名称' },
      ],
      ...
      formJson: [
        { label: '角色', prop: 'role', disable: false },
        { label: '角色名称', prop: 'role_name' },
        { label: '公司代码', prop: 'cm_code' },
        { label: '公司名称', prop: 'cm_name' },
        { label: '部门代码', prop: 'u_code' },
  ...
  methods: {
    ...
    UpDateInfo() {
      ...
      const filteredData = data.filter((item) => !this.form.hasOwnProperty("id"));

      var postdata = {
        id: this.editedId,
        table: this.listQuery.table,
        arr: JSON.stringify(filteredData)
      }
